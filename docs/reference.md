...
| Headroom | Downloaded, not yet use-through tested. | Compression, token savings, Codex/Claude/OpenAI proxy behavior, model-aware context reduction and observability. | Candidate context-efficiency reference; small project but high-priority because point breakthroughs can change A9 cost/quality. |
