...
This decision is constrained by the archived reference scan in
`docs/archive/2026-06-noise-reduction/role-memory-reference-scan.md`. Do not
treat this document as a self-invented final architecture; when it conflicts
with reference evidence or new run evidence, update a bounded evidence note and
this governance doc together.
