...
class RemoteBootstrapTests(unittest.TestCase):
    ...
    def test_bootstrap_script_contains_controller_repo_and_remote_dir(self):
        ...
        self.assertIn('"bootstrap_mode": "ssh_bootstrap_only"', script)
        self.assertIn('"runtime_mode": "redis_api_runtime"', script)
        self.assertIn('"heartbeat_tmux_session": "a9-heartbeat"', script)
