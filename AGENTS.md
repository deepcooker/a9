...
历史 plan-file 参考扫描已归档到
`docs/archive/2026-06-noise-reduction/requirements-plan-file-reference-scan.md`；
当前任务只按 `docs/context-governance.md` 和任务包点名的 bounded slice 读取。
...
`docs/context-governance.md`、`docs/project.md` 和 `docs/session-causal-memory.md`
接手；旧角色记忆治理细节已归档到
`docs/archive/active-indexes/2026-06-15/role-memory-governance.md`。
...
其他文档必须由任务包点名路径、用途和 bounded slice。`docs/session-raw-*`、
`docs/communication-observation-log.md`、`docs/agent-runtime-observations.md`、
`docs/mistakes.md`、`archive/original-ideas/*` 默认都是证据或原始材料，不是当前
执行合同。

重订需求分析后必须做噪音处理：标记过期支线、归档旧任务、删除无事实价值的 scratch
文件、把仍有价值的 raw evidence 变成索引，并更新 `docs/session-causal-memory.md`
...
- 已完成：MoE/monitor 从浅层 score 升级成归档方法索引
  `docs/archive/active-indexes/2026-06-15/moe-review-methodology.md`
...
- 已完成：OpenClaw policy attestation 第一版，summary/evidence/state/Redis session
  ...
  短引用。
- 下一刀：先暂停继续堆通讯功能，按归档交接索引
  `docs/archive/active-indexes/2026-06-15/stage-handoff-2026-06-01.md`
