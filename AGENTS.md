...
- session 精读、滚动总结和因果变迁：`docs/session.md`
- 项目当前状态：`docs/project.md`

旧的 session close-reading 和 session summary 文档已删除；
...
`docs/session.md`、`docs/mistakes.md`、`archive/original-ideas/*`
...
3. 必要时以 raw session 精读为事实源判断下一步。
...
- 精读后必须更新 `docs/session.md`，把因果变迁、过期支线和当前决策统筹进去。
- 到当前尾部自动停。
